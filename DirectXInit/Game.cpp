...
void Game::Init(HWND _hWnd)
{
	...
	//		blocks[x][y].SetPos(read_blockPositionList[y][x].x, read_blockPositionList[y][x].y, 0.0f);//位置を設定
	//		blocks[x][y].SetSize(BLOCKSIZE_X, BLOCKSIZE_Y, 0.0f);//大きさを設定
	//	
	//		data[x][y] = read_gridStateList[y][x];
	//	}
	//}
...
void Game::Update(void)
{
	...
	else if (input.GetKeyTrigger(VK_4))
	{
		int stageNum = STAGE4;
	...
	else if (input.GetKeyTrigger(VK_5))
	{
		int stageNum = STAGE5;
	...
	else if (input.GetKeyTrigger(VK_6))
	{
		int stageNum = STAGEINIT;
	...
	//	}
		...
		//		{
		//		case NULLBLOCK://空白
		//			blocks[x][y].SetColor(1.0f, 1.0f, 1.0f, 0.0f);
		//			break;
		//		case BOLL://ボール
		...
		//			break;
		//		case COIN://コイン
		//			blocks[x][y].SetColor(1.0f, 1.0f, 0.0f, 1.0f);
		//			break;
		//		case STICKY_BLOCK://粘着ブロック
		//			blocks[x][y].SetColor(0.0f, 1.0f, 0.0f, 1.0f);
		//			break;
		//		}
		//	}
		//}
